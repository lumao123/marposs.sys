...
<head>
    ...
    <style>
        ...
        .bootstrap-table{width: 1000px; margin: 20px auto 0;}
        ...
        .search-block{width: 100%; height: 70px; padding: 20px 0; background: #abcdef; margin: 0; text-align: center;}
        .search-block label{
            width: 100px; height: 30px; line-height: 30px;
            text-align: center; margin: 0 0; color: #666;;
        }
        .search-block .search-item{
            width: 180px; height: 30px; line-height: 30px; border-radius: 4px;
        }
        .search-btn{
            display: inline-block; width: 100px; height: 30px; line-height: 30px; text-align: center;
            background: #145f96; margin: 0 40px; color: #fff; border-radius: 4px; cursor: pointer;
        }
    </style>
</head>
<body>
